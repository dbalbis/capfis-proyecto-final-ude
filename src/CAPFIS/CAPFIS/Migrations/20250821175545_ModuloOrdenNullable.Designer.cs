...
namespace CAPFIS.Migrations
{
    ...
    [Migration("20250821175545_ModuloOrdenNullable")]
    partial class ModuloOrdenNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CAPFIS.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("CAPFIS.Models.EtapaModulo", b =>
                {
                    ...
                    b.Property<int>("ModuloInteractivoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ModuloInteractivoId");
            ...
            modelBuilder.Entity("CAPFIS.Models.EtapaModulo", b =>
                {
                    b.HasOne("CAPFIS.Models.ModuloInteractivo", "Modulo")
                        .WithMany("Etapas")
                        .HasForeignKey("ModuloInteractivoId")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CAPFIS.Models.ApplicationUser", null)
                        .WithMany()
